export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for platform user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for platform user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, Wavelet Innovation temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'Wavelet Innovation API Platform',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'Internal access to approved AI models and services',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'Wavelet Innovation API Platform',
        useTls: 'Use TLS',
