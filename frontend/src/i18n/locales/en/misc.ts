export default {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to Wavelet Innovation API Platform',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Wavelet Innovation API Platform is our private internal platform for secure access to approved AI models and services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Capabilities:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Model Routing</b> - Organize approved providers and model access</li><li>🔗 <b>Account Pool</b> - Connect managed upstream AI service accounts</li><li>🔑 <b>API Key Management</b> - Issue individual keys for authorized users and systems</li><li>🛡️ <b>Usage Controls</b> - Apply quotas, rates, and operational safeguards</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups define how approved users and systems reach AI models:</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent usage and rate controls</li><li>👥 Access can be shared or restricted to assigned users</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> Create separate groups for engineering, research, and controlled testing</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Wavelet Innovation API Platform',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Welcome to Wavelet Innovation\'s secure internal AI API platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create an authorized API key</li><li>📋 Configure it in your approved application</li><li>🚀 Access the AI models assigned to your group</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
