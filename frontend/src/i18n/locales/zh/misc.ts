export default {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Wavelet Innovation API Platform',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Wavelet Innovation API Platform 是公司内部 AI 平台，用于安全访问经过批准的模型与服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心能力：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>模型路由</b> - 管理已批准的服务商和模型访问</li><li>🔗 <b>账号池</b> - 连接并管理上游 AI 服务账号</li><li>🔑 <b>API 密钥管理</b> - 为授权用户和系统分配独立密钥</li><li>🛡️ <b>使用控制</b> - 配置配额、费率和安全策略</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组用于定义授权用户和系统如何访问 AI 模型：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的用量和费率控制</li><li>👥 访问权限可共享，也可限定给指定用户</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>可为工程、研究和受控测试分别创建分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 Wavelet Innovation API Platform',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">欢迎使用 Wavelet Innovation 安全的内部 AI API 平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建授权 API 密钥</li><li>📋 将密钥配置到获批应用中</li><li>🚀 访问分组分配的 AI 模型</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
